...
function setupChannel(target, channel, serializationMode) {
  ...
  // The channel accounts for one of the closes maybeClose() waits for, whether
  // the peer tears it down or disconnect() does. Only count it once.
  let channelCloseCounted = false;
  function countChannelClose() {
    if (channelCloseCounted) return;
    channelCloseCounted = true;
